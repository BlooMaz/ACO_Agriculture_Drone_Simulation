...
#the number of ants equals to the number of coordinates,get values
#num_city = @getSize of coordinates
#get all coordinate from one txt file then get size
for i in range(4):
    ...
    if i==0:
        size_coordinate1 = len(coordinate_temp)
    elif i==1:
        size_coordinate2 = len(coordinate_temp)
    elif i==2:
        size_coordinate3 = len(coordinate_temp)
    elif i==3:
        size_coordinate4 = len(coordinate_temp)
